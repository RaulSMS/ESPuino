...
uint8_t System_MaxInactivityTime = s_maxInactivityTime; // Time in minutes, after uC is put to deep sleep because of inactivity (0 = disabled, and modified later via GUI)
